    ...
    <div className="container d-flex justify-content-center m-5 formulario">
      ...
      {!loading && (
        <form onSubmit={handleSubmit}>
          ...
          <input type="text" className="form-control" value={formCheckout.name} onChange={handleName} placeholder="Nombre Completo..."/>          
          <label htmlFor="">Teléfono</label>
          <input type="text" className="form-control" value={formCheckout.phone} onChange={handlePhone} placeholder="0123456789" />          
          <label htmlFor="">Email</label>
          <input type="email" className="form-control" value={formCheckout.email} onChange={handleEmail} placeholder="@hotmail.com" />          
